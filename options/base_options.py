...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='cast', help='name of the experiment. It decides where to store samples and models')
    ...
    def gather_options(self):
        ...
        model_option_setter = cast_model.get_option_setter(model_name)
